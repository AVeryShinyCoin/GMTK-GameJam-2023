...
public class StartRaidButton : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerDownHandler, IPointerUpHandler
{
    ...
    public void OnPointerUp(PointerEventData eventData)
    {
        if (hoverOver)
        {
            ...
            GameController.Instance.StartRaid();
